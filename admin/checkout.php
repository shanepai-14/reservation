	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				...
				<button style="float:right;" class="shadow btn btn-light rounded-pill"  onclick="exportToExcel()">Export</button>
				<br />
				<br />
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo sprintf('Php %.2f', $fetch['bill'])?></td>
...
<script type = "text/javascript">
    ...
    /* Save to file */
    XLSX.writeFile(wb, "checkout_list.xlsx");
}  
</script>
</html>